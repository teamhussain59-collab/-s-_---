...
// ---------------- CONFIG ----------------
const BOT_NAME_FREE = 'ʜᴜsᴇ_ᴛᴇᴄʜ-ᴍᴅ-ᴍɪɴɪ';
...
const config = {
  ...
  FREE_IMAGE: 'https://files.catbox.moe/jx4rr3.png',
  ...
  DEFAULT_NEWSLETTERS: [
    ...
    { 
      ...
      emojis: ['❤️', '🌟', '🔥', '💯'],
      name: 'HUSE-MD Tech', //your channel name or just desplay name
...
case 'menu': {
  ...
  try {
    ...
    const title = userCfg.botName || '©ʜᴜsᴇ_ᴛᴇᴄʜ-ᴍᴅ ';
...
╭─「  \`🤖${title}\`  」 ─➤*  
*│
*│*🥷 *Oᴡɴᴇʀ :* ${config.OWNER_NAME || 'ʜᴜsᴇ_ᴛᴇᴄʜ-ᴍᴅ'}
